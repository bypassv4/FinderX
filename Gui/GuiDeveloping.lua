...
function Gui.MakeSelectionBox(Name, Parent, Options, MultiSelect)
    ...
    Options.Size = UDim2.new(1, 0, 4, 0)
    ...
    local function CreateDropdownButton(Name)
        ...
        Frame.Name = "InputFrame"
        Frame.BorderSizePixel = 0
        Frame.Size = UDim2.new(1, 0, 1/4, 0)
        Frame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
        Frame.Active = true
        Instance.new("UICorner", Frame)
...
UserInputService.InputBegan:Connect(function(input, gameProcessed)
    ...
    if input.KeyCode == Gui.CoreKeybind.Destroy then
        Gui.ScreenGui:Destroy()
        Gui.NotificationGui:Destroy()
        print("Destroyed gui.")
    elseif input.KeyCode == Gui.CoreKeybind.Toggle then
